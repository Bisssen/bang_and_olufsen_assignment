...
class text_gui():
    ...
    def inspect_specific(self, id_type: str) -> None:
        ...
        The type input is used to determine what kind of ID
        the program should be asking for
        ...
        if user_input.isdigit():
            ...
            # e.g. if id_type = user, then self.inspect_user will be called
    ...
    def inspect_user(self, user_id: str) -> None:
        while True:
            user_input = input('\n'
                               '1. Display the data of the user\n'
    ...
    def inspect_photo(self, photo_id: str) -> None:
        self.fetcher.fetch_and_print_all_of_topic('/photos/' + photo_id)

    def inspect_post(self, post_id: str) -> None:
        self.fetcher.fetch_and_print_all_of_topic('/posts/' + post_id)
