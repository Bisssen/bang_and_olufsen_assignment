...
from api_interactor.text_gui import text_gui, \
    TOP, USER, ALBUM, POST, PHOTO, COMMENT
...
fetch_and_print_all_patch =\
    patch(f'{fetcher_path}.fetch_and_print_all_of_topic')
...
def test_function_calls_in_end_states(
    ...
    fetch_and_print_all_of_topic_mock.\
        assert_called_with(f'/{function_name}s/1')
...
def test_unique_top_function_calls(
    ...
    def test_inspect_activate_exit_call(function_mock: Mock) -> None:
